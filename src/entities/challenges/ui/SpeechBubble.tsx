...
function SpeechBubble({ showBubble, message }: { showBubble: boolean; message: string }) {
  return (
    <AnimatePresence>
      {showBubble && (
        <motion.div
          className="relative flex items-center justify-center min-w-[300px] min-h-[60px] px-7 py-2 rounded-[20px] bg-[#ffffffcc] after:absolute after:w-0 after:h-0 after:bg-transparent after:-bottom-3 after:border-transparent after:border-l-[14px] after:border-l-transparent after:border-t-[12px] after:border-t-[#ffffffcc] after:border-r-[14px] after:border-r-transparent mb-2"
          initial={{
            y: -10,
            opacity: 0,
          }}
