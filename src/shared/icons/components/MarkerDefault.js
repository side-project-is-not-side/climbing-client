...
const SvgMarkerDefault = (props) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#marker-default_svg__a)" filter="url(#marker-default_svg__b)">
      <mask
        id="marker-default_svg__c"
        width={32}
        height={28}
        x={9}
        y={5}
      ...
      <g mask="url(#marker-default_svg__c)">
        <path
          fill="#C4C4C4"
    ...
    <defs>
      <clipPath id="marker-default_svg__a">
        <path fill={props.color ?? '#fff'} d="M9 5h32v28H9z" />
      </clipPath>
      <filter
        id="marker-default_svg__b"
        width={52}
        height={48}
        x={-1}
        y={-1}
      ...
      >
        ...
        <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_368_1051" />
        <feBlend in="SourceGraphic" in2="effect1_dropShadow_368_1051" result="shape" />
      </filter>
    </defs>
  </svg>
);
